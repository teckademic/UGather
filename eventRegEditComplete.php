<?php
	...
	try
	{
		...
		updateAttendee($eventID, $userID, $status);
		// echo "You are $status to this event";
		eventPlannerRegistrationEditNotification($eventID, $userID, $status, $eventTitle, $userFirstName, $userLastName, $plannerFirstName, $plannerLastName);
		attendeeRegistrationEditNotification($eventID, $eventPlanner, $userID, $status, $eventTitle, $userFirstName, $userLastName);
