<?php
	...
	// cannot perform if not logged in!
	checkValidUser();
	...
	$emailAddress = str_replace($apostrophe, "\'", $emailAddress);
	$emailAddress = str_replace($quotation, "&#34;", $emailAddress);
	...
	{	
		...
		updateUser($userID, $firstName, $lastName, $emailAddress, $streetAddress, $city, $state, $zipCode, $phoneNumber);
		// notifys user of the profile change
		notifyProfileChange($userID);
		header('location: editUserProfileConfirmation.php');
	}
				...
				{ 
                    ...
                    if (is_array($event)) 
                    {
                        foreach ($event as $rows)  
                        {
                            ...
                            <form name="editUserProfileForm" method="post" action="editUserProfileExecute.php">
                                 <table width="454" border="1">                          
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="firstName" type="text" id="firstName" value="<? echo $firstName2; ?>" size="30" maxlength="30" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="lastName" type="text" id="lastName" value="<? echo $lastName2; ?>" size="30"  maxlength="30" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><font color="332616">
                                            <input name="streetAddress" type="text" id="streetAddress" value="<? echo $streetAddress2; ?>" size="30" maxlength="175" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="emailAddress" type="text" id="emailAddress" value="<? echo $emailAddress2; ?>" size="30" maxlength="75" >
                                        </td>
                                    </tr>
                            </table>
