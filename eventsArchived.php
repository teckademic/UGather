...
<div id="wrap">
	...
	<div id="content">
		...
		<div id="main">
            ...
            <p>Click on an event name for more details. These events have already passed, and may NOT be registered for.
            <!-- sort form -->
            <form name="form1" method="post" action="eventsArchived.php" style="margin: 2px 2px; padding: 2px 2px 2px 2px; border: 1px solid #EEE8E1; background: #FAF7F5;">
            	&nbsp;&nbsp;Sort By: &nbsp;&nbsp;
			...
			<?php
				...
				{
					$result = getArchivedEventDetailsOrderByDesc($fieldsNeeded, $eventSortBy);
				}
				if ($eventSortHow == "ascending")
				{
					$result = getArchivedEventDetailsOrderByAsc($fieldsNeeded, $eventSortBy);	
				}
				
				if (!$result)
					throw new Exception("Error! No results found for first sql query!!");
				...
				if ($eventSortHow == "descending")
				{
					$q = getArchivedEventDetailsOrderByDescLimit($fieldsNeeded, $eventSortBy, $set_limit, $limit);
				}
				if ($eventSortHow == "ascending")
				{
					$q = getArchivedEventDetailsOrderByAscLimit($fieldsNeeded, $eventSortBy, $set_limit, $limit);	
				}
  				...
  				if(!$q) die(mysql_error()); 
       			...
       			if($err == 0) 
				{
					echo "<p><span style=\"color: #FF0000;\">There are no current events on uGather!</span></p>"; 
				} // end if
				else
				{ 
					?>   
						<p><a href="eventsArchived.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=5&amp;page=1">5 per page</a> | 
						<a href="eventsArchived.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=10&amp;page=1">10 per page</a> | 
						<a href="eventsArchived.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=20&amp;page=1">20 per page</a>
						</p>
					<?php
					...
					{ 
						?>
							<b>&lt;&lt;</b> <a href="eventsArchived.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=<? echo $limit; ?>&amp;page=<? echo $prev_page; ?>"><b>previous</b></a>
						<?php 
					} 
					...
					{ 
						...
						{ 
							?>
								<a href="eventsArchived.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=<? echo $limit; ?>&amp;page=<? echo $a; ?>"> <? echo $a; ?> </a> | 
							<?php
						} 
					} 
					...
					{ 
						?>
							<a href="eventsArchived.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=<? echo $limit; ?>&amp;page=<? echo $next_page; ?>"><b>Next</b></a> &gt; &gt;
						<?php
					} 
