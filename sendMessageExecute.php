<?php
	...
	// obtain from form on sendMessage.php
	...
	try
	{
		...
		if (filled_out($_POST))
		{
			...
			sendMessageToEventPlanner($eventID, $eventName, $recipientID, $userID, $messageText);
		...
		else
		{
			...
			throw new Exception("<br /><span style=\"color:red;\">You have not typed a message to send. Try again!</span>");
...
<div id="wrap">
	...
	<div id="content">
		...
		<div id="main">
            ...
            <!-- send message header -->
            <h2>Send Message to: <? echo $recipientID; ?></h2> 
            ...
            ?>
			<form name="sendMessage" method="post" action="sendMessageExecute.php?eventID=<? echo $eventID; ?>&amp;recipientID=<? echo $recipientID; ?>">	
				<!-- hidden form fields-->
