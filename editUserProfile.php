			...
			<?php
				...
				if (is_array($event)) 
				{
					foreach ($event as $rows)  
					{
						...
						<form name="editUserProfile" method="post" action="editUserProfileExecute.php">
                             <table width="454" border="1">                           
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="firstName" type="text" id="firstName" value="<? echo $rows['firstName']; ?>" size="30" maxlength="30" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="lastName" type="text" id="lastName" value="<? echo $rows['lastName']; ?>" size="30" maxlength="30" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><font color="332616">
                                        <input name="streetAddress" type="text" id="streetAddress" value="<? echo $rows['streetAddress']; ?>" size="30" maxlength="175" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="emailAddress" type="text" id="emailAddress" value="<? echo $rows['emailAddress']; ?>" size="30" maxlength="75" >
                                    </td>
                                </tr>
                        </table>
