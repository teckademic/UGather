<?php
	...
	if ($userID && $password) 
	{
		...
		try  
		{
			...
			{
				throw new Exception("<br /><span style=\"color:red;\">Username and password combination is incorrect. Please try again below.</span>");	
			}
			...
			<?php
				...
				{ ?>
					...
					<form name="form1" method="post" action="checklogin.php">		
						...
						<br />
						<input name="userID" type="text" id="userID" maxlength="20" value="<? echo $userID; ?>">
						</p>
