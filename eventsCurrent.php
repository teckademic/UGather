...
<div id="wrap">
	...
	<div id="content">
		...
		<div id="main">
            ...
            <p>Click on an event name for more details, or to register.
            <!-- sort form -->
            <form name="form1" method="post" action="eventsCurrent.php" style="margin: 2px 2px; padding: 2px 2px 2px 2px; border: 1px solid #EEE8E1; background: #FAF7F5;">
            	&nbsp;&nbsp;Sort By: &nbsp;&nbsp;
			...
			<?php
				...
				{
					$result = getCurrentEventDetailsOrderByDesc($fieldsNeeded, $eventSortBy);
				}
				if ($eventSortHow == "ascending")
				{
					$result = getCurrentEventDetailsOrderByAsc($fieldsNeeded, $eventSortBy);	
				}
				...
				if ($eventSortHow == "descending")
				{
					$q = getCurrentEventDetailsOrderByDescLimit($fieldsNeeded, $eventSortBy, $set_limit, $limit);
				}
				if ($eventSortHow == "ascending")
				{
					$q = getCurrentEventDetailsOrderByAscLimit($fieldsNeeded, $eventSortBy, $set_limit, $limit);	
				}
				...
				{ 
					?>   
						<p><a href="eventsCurrent.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=5&amp;page=1">5 per page</a> | 
						<a href="eventsCurrent.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=10&amp;page=1">10 per page</a> | 
						<a href="eventsCurrent.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=20&amp;page=1">20 per page</a>
						</p>
					<?php
					...
					{ 
						?>
							<b>&lt;&lt;</b> <a href="eventsCurrent.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=<? echo $limit; ?>&amp;page=<? echo $prev_page; ?>"><b>previous</b></a>
						<?php 
					} 
					...
					{ 
						...
						{ 
							?>
								<a href="eventsCurrent.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=<? echo $limit; ?>&amp;page=<? echo $a; ?>"> <? echo $a; ?> </a> | 
							<?php
						} 
					} 
					...
					{ 
						?>
							<a href="eventsCurrent.php?sortBy=<? echo $eventSortBy; ?>&amp;sortHow=<? echo $eventSortHow; ?>&amp;limit=<? echo $limit; ?>&amp;page=<? echo $next_page; ?>"><b>Next</b></a> &gt; &gt;
						<?php
					} 
